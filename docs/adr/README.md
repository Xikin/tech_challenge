...
| [0005](../../../oficina-infra-k8s/docs/adr/0005-restricoes-aws-academy.md) | Restrições do AWS Academy (LabRole, credenciais de 4h, sem NAT) | Aceita |
| [0006](../../../oficina-auth-lambda/docs/adr/0006-segredos-da-lambda.md) | Segredos injetados no deploy, não lidos em runtime | Aceita |
| [0007](../../../oficina-infra-k8s/docs/adr/0007-eks-em-vez-de-k3s.md) | EKS gerenciado em vez de k3s de nó único | Aceita |
