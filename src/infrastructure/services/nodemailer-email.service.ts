    ...
    await this.transporter.sendMail({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;margin:16px 0">
          <tr><td style="padding:4px 12px;font-weight:bold">De:</td><td style="padding:4px 12px">${dados.statusAnterior}</td></tr>
          <tr><td style="padding:4px 12px;font-weight:bold">Para:</td><td style="padding:4px 12px;color:#1a7f37">${dados.statusNovo}</td></tr>
